...
{
	public class OrlDb : IDb
	{
        private readonly object objLock = new object();
		protected OrlProvider provider;
        ...
        string orlProvider = "Oracle.DataAccess.Client";
		...
		private OrlTable TableFor(Type type)
		{
			return OrlTableFactory.Instance.Build(type);
		}
		...
		{
			ErrorIfClosed();
            StringBuilder buf = new StringBuilder("EXECUTE IMMEDIATE @retval:=").Append(procName);
			IDbCommand cmd = null;
