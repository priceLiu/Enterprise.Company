...
{
    public class OrlTableFactory
    {
        public static readonly OrlTableFactory Instance = new OrlTableFactory();

        private LRUCache<OrlTable> cache = new LRUCache<OrlTable>(50);

        private OrlTableFactory()
        { }
